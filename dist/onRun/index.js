...
const waitUntilContainersAreReady_1 = __importDefault(require("./waitUntilContainersAreReady"));
...
const onRun = async (config) => {
    ...
    const waitUntilContainersAreReadyPromise = waitUntilContainersAreReady_1.default(runners);
    ...
    await waitUntilContainersAreReadyPromise;
